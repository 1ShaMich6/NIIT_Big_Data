...
public class TopLossProductsDriver 
{
	public static void main(String args[]) throws Exception
	{
		...
		job1.setJarByClass(TopLossProductsDriver.class);
		...
		Path outputPath1 = new Path("/retail/job1_output1");
		...
		//Map-Reduce 2
		Job job2 = Job.getInstance(conf, "Top 5 loss products for each age group Computation");
		job2.setJarByClass(TopLossProductsDriver.class);
		job2.setMapperClass(SortMapper.class);
		
		job2.setPartitionerClass(SortPartitioner.class);
		
//		This is because loss is in negative ... so more negative amount --> more loss
